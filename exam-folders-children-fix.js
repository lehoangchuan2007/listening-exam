...
(function(){
  ...
  async function boot(){
    ...
    await loadScript('exam-folders-windows-ui','./exam-folders-windows-ui.js?v=10');
    ...
    await loadScript('exam-folders-ui-polish','./exam-folders-ui-polish.js?v=2');
