-- English Studio - expose Writing rubric to the student Writing page
-- Run once in Supabase SQL Editor after writing-rubric.sql
...
begin
  ...
  select jsonb_build_object(
    ...
    'writing_prompt', coalesce(nullif(e.writing_prompt,''), nullif(e.description,''), e.title),
