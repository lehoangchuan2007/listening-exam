...
(function(){
  ...
  // Reuse the single Auth client created by student.html/student-auth.js.
  ...
  async function showHistory(){
    ...
    const r=await client.rpc('get_student_history');if(r.error){app.innerHTML='<div class="card notice danger">❌ '+esc(r.error.message)+'</div>';return;}
